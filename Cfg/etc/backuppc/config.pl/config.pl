...
#
$Conf{FullKeepCntMin} = '50';
$Conf{FullAgeMax} = '3650';
...
# (eg: /etc/rsyncd.secrets).
#
$Conf{RsyncdPasswd} = 'FursegToosEacnatIgNuetAbciVavPeg';
...
#
$Conf{EMailFromUserName} = 'backuppc@my-domain';
...
# name (eg: "admin@mydomain.com").
#
$Conf{EMailAdminUserName} = 'admin@my-domain';
...
#
$Conf{EMailUserDestDomain} = 'my-domain';
